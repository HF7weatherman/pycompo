...
COMPO_PLOT_LABEL = {
    ...
    'dts_dx': 'downwind sfc. temp. gradient',
    'dts_dy': 'crosswind sfc. temp. gradient',
    'ts_laplacian': 'sfc. temperature Laplacian',
    'tas': '2m air temperature',
    'downwind_ts_grad': 'downwind sfc. temp. gradient',
    'crosswind_ts_grad': 'crosswind sfc. temp. gradient',
    'pr': 'precipitation',
    ...
    'rlut': 'TOA OLR',
    'ps': 'surface pressure',
    'cllvi': 'column cloud liquid water',
    'clivi': 'column cloud ice',
    'sfcwind': 'surface windspeed',
    'uas': 'zonal windspeed',
    'vas': 'meridional windspeed',
    'sfcwind_conv': 'surface wind convergence',
    'ua': "downwind windspeed",
    'va': "crosswind windspeed",
    'ta': 'temperature',
...
CLABEL = {
    ...
    'dts_dx': "dts_dx / K m-1",
    'dts_dy': "dts_dy / K m-1",
    'ts_laplacian': "ts_laplacian / K m-2",
    ...
    'cllvi': "cllvi / kg m-2",
    'clivi': "clivi / kg m-2",
    'sfcwind': "sfcwind / m s-1",
    'sfcwind_conv': "sfcwind_conv / s-1",
    'uas': "uas / m s-1",
    'vas': "vas / m s-1",
    'ua': "ua / m s-1",
    'va': "va / m s-1",
...
CLABEL_NICE = {
    ...
    'dts_dx': "K$\,$/$\,$100$\,$km",
    'dts_dy': "K$\,$/$\,$100$\,$km",
    'ts_laplacian': "K$\,$/$\,$100$\,$km$^{2}$",
    'downwind_ts_grad': "K$\,$/$\,$100$\,$km",
    'crosswind_ts_grad': "K$\,$/$\,$100$\,$km",
    'tas': "K",
    'pr': "mm$\,$day$^{-1}$",
    'hfls': "W$\,$m$^{-2}$",
    'hfss': "W$\,$m$^{-2}$",
